...
const Collection = () => {
  ...
  function ApplyFilter() {
    let productsCpy=products.slice(27,)
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60' >
        ...
        <div className={`border boder-gray-300 pl-5 py-3 mt-6 ${showFilter ? "" : "hidden"} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            {/* <p className='flex gap-2'>
              <input type="checkbox" className='w-3' value={"Mobile"} onChange={toggleCategory} />Mobile
            </p> */}
        ...
        <div className={`border boder-gray-300 pl-5 py-3 my-5 ${showFilter ? "" : "hidden"} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            ...
            <p className='flex gap-2'>
              <input type="checkbox" className='w-3' value={"OPPO"} onChange={toggleSubCategory} />OPPO
            </p>
            <p className='flex gap-2'>
              <input type="checkbox" className='w-3' value={"INFINIX"} onChange={toggleSubCategory} />INFINIX
            </p>
            <p className='flex gap-2'>
              <input type="checkbox" className='w-3' value={"SAMSUNG"} onChange={toggleSubCategory} />SAMSUNG
            </p>
            <p className='flex gap-2'>
              <input type="checkbox" className='w-3' value={"REALME"} onChange={toggleSubCategory} />REALME
            </p>
            <p className='flex gap-2'>
              <input type="checkbox" className='w-3' value={"XIAOMI"} onChange={toggleSubCategory} />XIAOMI
            </p>
          </div>
        </div>
      ...
      <div className='flex-1'>
        ...
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          <Title text1={"MOBILE"} text2={"COLLECTION"} />
          {/* Products sort */}
